...
@section('content_header')
    <h1><i class="fas fa-user-edit mr-2"></i> Edit Data Pasien</h1>
@stop
        ...
        <div class="col-md-8 mx-auto">
            <div class="card card-warning card-outline shadow-sm">
                <div class="card-header">
                    <h3 class="card-title">Update Informasi Pasien</h3>
                </div>
                <form action="{{ route('patients.update', $patient->id) }}" method="POST">
                    ...
                    <div class="card-body">
                        <div class="form-group mb-3">
                            ...
                            <input type="text" name="name" id="name" class="form-control form-control-lg @error('name') is-invalid @enderror" value="{{ old('name', $patient->name) }}" required>
                            @error('name')
                        ...
                        <div class="form-group mb-3">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" name="phone_number" id="phone_number" class="form-control @error('phone_number') is-invalid @enderror" value="{{ old('phone_number', $patient->phone_number) }}">
                            </div>
                            @error('phone_number')
